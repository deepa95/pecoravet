<%-- 
    Document   : header
    Created on : 20 Nov, 2018, 2:27:59 PM
    Author     : DEEPA
--%>

<%-- 
    Document   : header
    Created on : 20 Nov, 2018, 2:24:12 PM
    Author     : DEEPA
--%>
...
<html lang="en">
  <head>
    <title>Pecoravet - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Pecora<span>Vet</span></a>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/n16.png');" data-stellar-background-ratio="0.5">
